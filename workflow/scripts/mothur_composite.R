...
mothur_tidy_metadata <- read_csv("data/mothur_tidy_metadata.csv", show_col_types = FALSE)
mothur_tidy_otutable <- read_csv("data/mothur_tidy_otutable.csv", show_col_types = FALSE)
...
write_csv(mothur_composite, "data/mothur_composite.csv")