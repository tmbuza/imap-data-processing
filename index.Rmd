...
date:
- IMAP-PART 06<br>[Latest GitHub-Repo](https://github.com/tmbuza/imap-data-preprocessing/)<br>
...
A detailed interactive snakemake HTML report is available [here](https://complexdatainsights.com/imap/imap-data-preprocessing/report.html). 
...
```{r mothur, child='workflow/scripts/01_mothur_data_processing.Rmd'}
```

<br><hr width=100%><br>

## Processing `QIIME2` output
```{r qiime2, child='workflow/scripts/02_qiime2_data_processing.Rmd'}
```
...
| [IMAP-PART 07](https://github.com/tmbuza/imap-data-preprocessing/) | Processing Output from 16S-based microbiome bioinformatics pipelines| [In-progress](https://tmbuza.github.io/imap-data-preprocessing/) |
