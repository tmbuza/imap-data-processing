...
save(qiime2_tidy_metadata, qiime2_tidy_otutable, qiime2_tidy_taxonomy, qiime2_composite, ps_tree, ps_raw, ps_rel,  file = "data/qiime2/qiime2_phyloseq_objects.rda")
```
