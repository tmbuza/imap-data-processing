...
# QIIME2  metadata
qiime2_metadata <- read_tsv("../imap-bioinformatics-qiime2/resources/metadata/qiime2_metadata_file.tsv", 
                            show_col_types = FALSE) %>% 
  rename(sample_id="sample-id")


# QIIME2  otutable
qiime2_otutable <- read_tsv("../imap-bioinformatics-qiime2/qiime2_process//transformed/feature-table.tsv", skip = 1, show_col_types = FALSE) %>%
...
# QIIME2 taxonomy
qiime2_taxonomy <- read_tsv("../imap-bioinformatics-qiime2/qiime2_process/transformed/taxonomy.tsv", show_col_types=FALSE) %>% 
